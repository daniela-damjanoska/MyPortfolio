let sites = [
    {
        id: 1,
        title: 'COIN TRACKER',
        url: 'https://danieladam-coin-tracker.netlify.app/',
        desc: 'CoinTracker is an app for tracking the monthly income and expenses with the possibility of setting budget limits. The user can add/edit income/expense categories (on categories page, with click on chosen category for editing) and add/edit income/expense entries (with click on "plus" floating button on the bottom navigation and on click on chosen entry or right click on the Entries section on the overview page). There is also a statistics page where the user can find the data about the current month.',
        tech: 'React and Material-UI',
    },
    {
        id: 2,
        title: 'STREET ARTIST',
